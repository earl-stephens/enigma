...
class OffsetTest < Minitest::Test
  ...
  def test_CEO_tester_method
    ...
    assert_equal [7, 6, 0, 4], offset.get_the_last_four
  end
  ...
  def test_CEO_main_method
    ...
    assert_equal 4, offset.get_the_last_four.length
    assert_equal Array, offset.get_the_last_four.class
    assert_equal Integer, offset.get_the_last_four[2].class
  end
